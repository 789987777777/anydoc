...
5. Scanned and image-only pages need OCR, which anydoc does not do; the document exits 3 and the message says how many. The hosted [Firecrawl Parse](https://firecrawl.dev/parse) API handles those.
